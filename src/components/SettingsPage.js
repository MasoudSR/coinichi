				...
				<div className="overflow-scroll pb-4 no-scrollbar">
					...
					<div
						...
						<div className="p-4 gap-3 flex flex-col text-white justify-between items-center">
							<p
								className={`text-sm  flex justify-center overflow-hidden items-center origin-bottom rounded-2xl transition-all duration-500 ${passwordNotification.error ? "bg-red-500" : "bg-green-500"} ${
							...
							<form className="flex flex-col gap-3 w-full" action={setPasswordHandler}>
								...
								/>
								<button className="flex flex-col border-2 border-sky-200 justify-center items-center rounded-lg p-3" type="submit">
									OK
								</button>
							</form>
						</div>
